 ...
 *
 * Höhe folgt `visualViewport` (CSS-Vars), damit die Safari-URL-Leiste auf
 * iPhone die Footer-Buttons nicht überdeckt.
 */
export default function PhoneFrame({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div
      className="fixed inset-x-0 flex w-full items-center justify-center overflow-hidden bg-neutral-950 sm:inset-0 sm:h-dvh sm:p-6"
      style={{
        top: "var(--app-top, 0px)",
